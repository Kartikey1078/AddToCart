...
// import starSolid from '../images/starSolid.svg'

import { MyContext } from "../MyContext";

function ProductCart() {
  const { setCartCount, setCartAmount, like, setLike } = useContext(MyContext);
    ...
    <div className="max-w-4xl mx-auto p-4 flex flex-col md:flex-row items-center md:items-start gap-6">
      <div className="w-full md:w-1/2">
        ...
        <div className="grid grid-cols-4 gap-2">
          <img
            src={img2}
            alt="Thumbnail 1"
            className="w-full cursor-pointer rounded-lg hover:opacity-75 object-cover"
          />
          <img
            src={img3}
            alt="Thumbnail 2"
      ...
      <div className="w-full md:w-1/2 text-center md:text-left flex flex-col justify-center">
        ...
        <div className="flex items-center justify-center md:justify-start gap-2">
          ...
          <span className="text-red-500 text-sm bg-red-100 px-2 py-1 rounded-lg">
            50% Off
          </span>
        </div>
